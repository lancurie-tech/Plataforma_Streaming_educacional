    ...
    materials: [
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/Glossario-do-Participante_Mod1.pdf',
      },
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/Guia-do-Participante_Mod1.pdf',
      },
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/Guia-educativo-Encaminhamento-e-busca-de-ajuda-_Mod1.pdf',
      },
      {
        title: '4. Leitura sugerida',
        description: 'Excerto traduzido do: WHO guidelines on mental health at work.',
        pdfUrl: 'https://example.com/demo-pdfs/Traducao-OMS_Mod1.pdf',
      },
    ],
  },
  {
    ...
    materials: [
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/LEI-No-14.831-DE-27-DE-MARCO-DE-2024.pdf',
      },
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/Guia-Fatores-de-Riscos-Psicossociais-MTE.pdf',
      },
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/FAQ-Perguntas-e-Respostas-GRO-e-PGR-da-NR-01.pdf',
      },
    ],
  },
];
    ...
    materials: [
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/Equilibrio-e-Limites_Mod2.pdf',
      },
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/Checklist-e-Sinais_Mod2.pdf',
      },
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/Saude-mental-e-risco-cardiovascular_Mod2.pdf',
      },
      {
        title: '4. Leitura sugerida',
        description:
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/Traducao-NICE_Mod2.pdf',
      },
    ],
  },
  {
    ...
    materials: [
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/9789241599313_por_Mod2.pdf',
      },
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/cartilha-amarela-n_Mod2.pdf',
      },
      {
        ...
        pdfUrl:
          'https://example.com/demo-pdfs/Cartilha-Prevencao-de-suicidios_Mod2.pdf',
      },
    ],
  },
];
...
const seed = {
  courses: {
    demo: {
      ...
      description:
        'Programa educacional sobre saúde mental no trabalho, fatores psicossociais e NR-1 (conteúdo de demonstração Plataforma de streaming educacional).',
      modules: {
        'mod-01': {
