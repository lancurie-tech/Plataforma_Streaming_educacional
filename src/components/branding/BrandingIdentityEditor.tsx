...
export type BrandingIdentityEditorProps = {
  /** `null` = documento global `siteContent/branding` (admin legacy sem tenant). */
  brandingTenantId: string | null;
  /** Mensagem contextual sob o subtítulo (ex.: admin vs master). */
...
export function BrandingIdentityEditor({ brandingTenantId, infoBanner }: BrandingIdentityEditorProps) {
