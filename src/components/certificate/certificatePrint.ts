...
export type CertificatePrintBranding = {
  platformDisplayName: string;
  platformShortName: string;
  logoSrc: string;
};

export function openCertificatePrintWindow(c: UserCertificate, branding: CertificatePrintBranding): void {
  ...
  const logoUrl = certificateLogoAbsoluteUrl(branding.logoSrc);
...
<div class="sheet">
  ...
  <div class="wrap">
    ...
    <div class="inner">
      <p class="grant">${escapeHtml(`A ${branding.platformDisplayName} confere a`)}</p>
      ...
      <div class="sigs">
        <div class="sig"><div class="sig-line"></div><p class="sig-label">${escapeHtml(branding.platformShortName)}</p></div>
