  ...
  ({ className, variant = 'primary', isLoading, disabled, children, ...props }, ref) => (
    <button
      ...
      className={clsx(
        ...
        variant === 'primary' &&
          'bg-(--brand-primary) text-white hover:bg-(--brand-primary-hover) focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--brand-primary-hover)',
        variant === 'outline' &&
