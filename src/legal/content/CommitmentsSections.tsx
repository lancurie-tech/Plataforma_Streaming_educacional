...
export function CommitmentsSections() {
  ...
  return (
    <>
      ...
      <h2>1. Veracidade das informações</h2>
      <p>
        Declaro que os dados fornecidos no cadastro (incluindo nome, e-mail, CPF quando solicitado e chave de
        acesso fornecida pela empresa) são verdadeiros e atualizados, responsabilizando-me por informações
        falsas ou de terceiros utilizadas indevidamente.
      </p>

      <h2>2. Uso adequado da plataforma</h2>
      <p>
      ...
      <p>
        Entendo que os cursos têm caráter formativo e podem abordar temas de saúde, segurança do trabalho e
        regulamentações (como referências a normas e boas práticas aplicáveis ao contexto do curso), sem
        constituir consulta médica, jurídica ou técnica individualizada. Em caso de emergência ou crise pessoal,
        devo buscar canais adequados (serviços de saúde, emergência, apoio psicológico institucional da minha
        empresa, quando existir).
      </p>

      <h2>5. Dados e relatórios</h2>
      <p>
        Estou ciente de que a empresa contratante pode receber informações sobre progresso e resultados de
        aprendizagem necessários à gestão do programa de capacitação, nos termos da Política de Privacidade e da
        legislação aplicável.
      </p>

      <h2>6. Sanções em caso de violação</h2>
      <p>
